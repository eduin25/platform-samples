...
<div id = "menu1" class = "atenuación del panel de pestañas del contenedor"> <br>
...
<script> 
        ...
        función ventanaSecundaria (URL) { 

        window.open (URL, "ventana1", "ancho = 300px, alto = 300px, barras de desplazamiento = NO") 
...
$ (documento) .ready (function () { 
    ...
    var fcurp = document.getElementById ("curp"). valor;
    ...
    $ .get ('https://cors-anywhere.herokuapp.com/api.siged.sep.gob.mx/servicios/alumno/ciclosAlum/curp='+ fcurp)
			...
			.done ((datos) => {        var t = data.response.docs;
